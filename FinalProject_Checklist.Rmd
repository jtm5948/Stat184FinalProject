...
(A) .Rmd Line numbers where at least two different data sources are imported: 20-22, 26-28
...
(A) .Rmd Line number(s) for general data wrangling: 40-60, 66-79


(B) .Rmd Line number(s) for a join operation: 101-111, 116-117
...
(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 45, 53, 60


(F) .Rmd Line number(s) for use of user-defined functions: None


(G) .Rmd Line number(s) for use of loops and/or control flow: 85-94
...
(A) .Rmd Line numbers for use of multiple different geoms: 140 & 148

(B) .Rmd Line number(s) for use of multiple aesthetics: 140

(C) .Rmd Line number(s) for use of layered graphics:  None

(D) .Rmd Line number(s) for use of leaflet or choropleth maps:  None
